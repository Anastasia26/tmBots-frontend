<template>
  <div class="container how_make_request_section" ref="containerLoading" v-model="footersData">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.getHowMakeReqInfo().then(response => {
                if (response) {
        ...
        methods: {
            ...mapActions('account', ['getHowMakeReqInfo']),
        }
    }
</script>
